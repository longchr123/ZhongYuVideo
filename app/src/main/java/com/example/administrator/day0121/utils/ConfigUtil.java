...
public class ConfigUtil {
    ...
    // 配置API KEY
    public final static String API_KEY = "KSUgyLDofierYUnwZUV730KLskvgd1pw";

    // 配置帐户ID
    public final static String USERID = "31B62BE07F62239F";
    ...
    //配置存在shareapreferance中key
    public final static String spKey = "zhongyujiaoyu";
    ...
    /**
     * SharedPreferences文件配置
     */
    public final static String NAME="shipin";
    public final static String FROMSUB="IsComeFromSubject";
    public final static String FROM_NOTIFICATION="IsComeFromNotification";

    /**视频格式*/
    public final static String FORMAT=".pcm";
